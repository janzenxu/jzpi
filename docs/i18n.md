...
JZPI's interface uses a small internal i18n layer. It is intentionally kept
...
/** JZPI Japanese language package. */
...
JZPI is a user-facing web interface. Internationalization is therefore an
...
support should lower the barrier to using JZPI, not be treated as a measure
